...
import { animateServicesPage } from "../utils/pagesAnimation/animateServices.js";
...
export default function renderServicesPage(container) {
        ...
        <section class="services-cards-sec" id="services-cards">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 my-3">
                        <div class="service-content right-service d-flex w-100 h-100 align-items-center">
                    ...
                    <div class="col-lg-6 my-3">
                        <div class="service-content left-service d-flex w-100 h-100 align-items-center">
                            <div class="service-card">
    ...
    const layoutHeight= document.querySelector('.services-layout');
