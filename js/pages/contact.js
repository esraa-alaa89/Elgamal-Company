...
import { animateContactPage } from "../utils/pagesAnimation/animateContact.js";
...
export default function renderContactPage(container) {
            ...
            <section class="contact-body" id="contact-body">
                <div class="container"> 
                    <div class="row gx-lg-5">
                        ...
                        <div class="col-lg-6 mt-3 mt-lg-5 form-section">
    ...
    const layoutHeight= document.querySelector('.contact-layout');
