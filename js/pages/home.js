...
import { animateHomePage } from "../utils/pagesAnimation/animateHome.js";
    ...
    <section class="service-sec py-5" id="services">
        <div class="container">
            ...
            <div class="service-title">
                <div class="col-12">
                    <h1 class="sec-preTitle me-3">What we do</h1>
                    <h2 class="sec-title mb-lg-5">Our Services</h2>
                </div>
            </div>
    ...
    <section class="projects-sec py-5" id="projects">
        <div class="container">
            ...
            <div class="projects-title">
                <div class="col-12">
                    <h1 class="sec-title me-3">Featured works</h1>
                    <h2 class="sec-preTitle mb-lg-5">Our latest Projects</h2>
                </div>
            </div>
